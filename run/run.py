...
from run.summary import SummaryGenerator
...
def main():
    ...
    avg_score = sum(r['critic_score'] for r in results if r['critic_score']) / len([r for r in results if r['critic_score']]) if results else 0
